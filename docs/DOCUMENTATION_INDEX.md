...
| **[PM_LAST_COMMIT_UPDATE_SUMMARY.md](./PM_LAST_COMMIT_UPDATE_SUMMARY.md)**                               | Cross-suite sync guide (`greenway-suite`, `xtrawrkx-suite`): PM privacy, permissions, Reporter edit/delete, file mapping, Cursor checklist |
