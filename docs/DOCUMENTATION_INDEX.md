...
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[LANDING_FONTS_AND_BASED_ON_DATA_SECTION.md](./LANDING_FONTS_AND_BASED_ON_DATA_SECTION.md)**          | Landing: Host Grotesk + Inter (CRM/PM parity), `BasedOnDataSection` home cards                                                                   |
| **[LANDING_HERO_SECTION.md](./LANDING_HERO_SECTION.md)**                                                 | Landing home: dark hero + beam + CRM frame (see fonts doc for current typography)                                                                  |
| **[LANDING_HOMEPAGE_REDESIGN_MAY_2026.md](./LANDING_HOMEPAGE_REDESIGN_MAY_2026.md)**                    | Landing home redesign: industries replica, hook section, why-us (6 cards), app features showcase, footer, and hero alignment pass                    |
