  ...
  return (
    <main className="min-h-screen bg-brand-light px-6 pt-28 pb-16">
      <div className="mx-auto w-full max-w-5xl">
        ...
        <h1 className="mt-2 text-4xl md:text-5xl font-bold text-brand-dark">Project Management</h1>
        <p className="mt-4 max-w-2xl text-lg text-gray-700">
          A focused Project Management page so the Navbar dropdown link opens correctly.
        </p>
